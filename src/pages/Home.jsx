  ...
  return (
    <main>
        ...
        <div className='w-full h-auto overflow-hidden'>
          <div className='flex flex-col justify-center items-center'>
            ...
            ${videoVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
              ...
              <h1
                ref={videoRef}
                className="uppercase cursor-default font-clash font-clash font-bold text-[11rem] hover:font-light duration-200 "
              >
                Hossam Saieed
                </h1>
              </div>
      ...
      <img src={DiamondIcon} alt='diamondIcon' />
          <h1 ref={textRef} className='uppercase font-clash font-medium text-7xl px-10'>{homePageSecondSectionText}</h1>
          <img src={DiamondIcon} alt='diamondIcon' />
      ...
      <section className="flex flex-col justify-center items-center min-h-screen">
        <div className={`gap-[56px] border-t border-b border-grey-800 flex flex-col items-center pt-[80px] pb-[80px] transition-all duration-1000 ${recentProjectsVisible ? 'scale-90' : 'scale-75'}`}>
           <div className='flex flex-col items-center'>
             <p  className='uppercase font-clash font-medium text-7xl px-10 m-1'>{recentProjectsTitleFirstPart}</p>
              <p className='uppercase font-clash font-medium text-7xl px-10 m-1'>{recentProjectsTitleSecondPart}</p>
          </div>
      ...
      <section className="flex flex-col justify-around items-start my-12 min-h-96">
        <h1 className='uppercase font-clash font-medium text-7xl px-10 m-1'>{whatIcanDoTitle}</h1>
